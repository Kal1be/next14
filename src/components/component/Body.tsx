    ...
    <div className='mt-24'>
      ...
      <div className='md:flex my-8 md:px-16 px-4 gap-16 justify-between'>
        ...
        <div className='md:w-[800px] text-lg font-medium'>
            <h2 className='opacity-65 '>Every day, Google Analytics, Google Search Console and your web server collect millions of data rows, and SEO experts often only look at summary graphs and rejoice when they increase and get upset when they decrease. It is time to understand the causes and consequences and take the first step in Data Science - dig into this data with your head and find answers to all your questions.
<br /><br />
There’s no need to invent Google's conspiracy theories if you can find out how data science works and test its main techniques in SEO. Book your seat to get instant access to the course.</h2>
